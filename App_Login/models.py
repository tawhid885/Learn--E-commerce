...
class MyUserManager(BaseUserManager):
    ...
    # A custom manager to deal with emails as unique identity
...
class User(AbstractBaseUser, PermissionsMixin):
    ...
    help_text = ugettext_lazy('Designates whether this user should be treated as active. Unselect instead of deleting accounts.'))
